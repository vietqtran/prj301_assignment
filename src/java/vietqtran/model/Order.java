...
public class Order {
    ...
    public Order(long userId, long shopId, long shipperId, double totalPrice, double saleTotalPrice, Date successDate, String phone, String address, long voucherId, String status, String note, String deliveryChecking) {
        this.userId = userId;
        this.shopId = shopId;
        this.shipperId = shipperId;
        this.totalPrice = totalPrice;
