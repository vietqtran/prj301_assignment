...
public class Product {
    ...
    public Product(String name, double price, double salePrice, String description, String city, double rate, Date createDate, int boughtQuantity, long color, long categoryId, long shopCategoryId, long shopId, String createBy, String deleteBy, String url) {
        this.name = name;
        this.price = price;
        this.salePrice = salePrice;
        this.description = description;
