...
public class ShipCompanyDAO extends DBContext implements IDAO<ShipCompany> {
    ...
    public void add(ShipCompany t) throws SQLException {
        try {
            PreparedStatement ps = connection.prepareStatement(Global.INSERT_SHIP_COMPANY);
    ...
    public void update(ShipCompany t) throws SQLException {
        try {
            PreparedStatement ps = connection.prepareStatement(Global.UPDATE_SHIP_COMPANY);
    ...
    public static void main(String[] args) throws SQLException {
        ...
        ShipCompany s = new ShipCompany("test", "test");
        ShipCompany s2 = new ShipCompany(11, "test2", "test2");
        dao.update(s2);
        dao.delete(11);
    }
