...
<html>
	...
	<div class="bg-neutral-100 pt-5 pb-10 w-full border-b-4 border-blue-500">
		...
		<div class="hidden grid-cols-12 rounded-sm bg-white px-9 py-5 text-sm capitalize text-gray-500 shadow lg:grid">
			...
			<div class="flex items-center">
			    <div class="flex flex-shrink-0 items-center justify-center pr-3"><input type="checkbox" class="accent-primary h-5 w-5" /></div>
		...
		<div class="my-3 rounded-sm bg-white shadow p-5">
			...
			<div class="flex items-center gap-x-3 lg:col-span-6">
			    <div class="flex items-center justify-center gap-x-3">
				<input type="checkbox" class="h-5 w-5" />
				<a class="h-14 w-14 flex-shrink-0 sm:h-20 sm:w-20" href=""> <img alt="Điện Thoại Vsmart Active 3 6GB/64GB - Hàng Chính Hãng" src="https://api-ecom.duthanhduoc.com/images/bbea6d3e-e5b1-494f-ab16-02eece816d50.jpg" class="h-14 w-14 object-cover sm:h-20 sm:w-20" /> </a>
			    </div>
			    <div class="flex flex-col items-start gap-y-1 lg:flex-row lg:gap-y-0">
				<a class="line-clamp-1 text-left lg:line-clamp-2" href="/Điện-Thoại-Vsmart-Active-3-6GB64GB--Hàng-Chính-Hãng-60afb2c76ef5b902180aacba">Điện Thoại Vsmart Active 3 6GB/64GB - Hàng Chính Hãng</a>
				<div class="flex items-center gap-x-3 lg:hidden"><span class="text-gray-300 line-through">₫3.990.000</span><span class="hidden lg:block">₫3.190.000</span><span class="text-primary block lg:hidden">₫3.190.000</span></div>
				<div class="flex gap-x-3 lg:hidden">
				    <div class="flex items-center">
					<button class="flex h-6 w-6 items-center justify-center rounded-l-sm border border-gray-300 text-gray-600 sm:h-8 sm:w-8">
					...
					<div class="">
					    <input type="text" placeholder="" class="h-6 w-9 rounded-none border-b border-t border-gray-300 p-1 text-center outline-none sm:h-8 sm:w-14" value="1" />
					    <div class="hidden"></div>
					</div>
					<button class="flex h-6 w-6 items-center justify-center rounded-r-sm border border-gray-300 text-gray-600 sm:h-8 sm:w-8">
				    ...
				    <button class="text-primary bg-none py-1 px-2 rounded-sm text-white bg-red-500">Xóa khỏi giỏ</button>
				</div>
			    </div>
			</div>
			<div class="col-span-6">
				...
				<div class="col-span-2">
				    <div class="hidden items-center justify-center gap-x-3 lg:flex"><span class="text-gray-300 line-through">₫3.990.000</span><span class="hidden lg:block">₫3.190.000</span><span class="text-primary block lg:hidden">₫3.190.000</span></div>
				</div>
				...
				<div class="col-span-1 hidden lg:block"><span class="text-primary">₫3.190.000</span></div>
				<div class="col-span-1 hidden lg:block">
				    <button class="text-primary bg-none py-1 px-4 rounded-sm text-white bg-red-500">Xóa</button>
				</div>
			    </div>
			</div>
		    </div>
		...
		<div class="sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white px-8 py-3 shadow lg:flex-row lg:items-center">
		    <div class="flex items-center">
			<div class="flex flex-shrink-0 items-center justify-center pr-3"><input type="checkbox" class="accent-primary h-5 w-5" /></div>
			<button class="mx-3 border-none bg-none">Chọn tất cả (1)</button><button class="mx-3 border-none bg-none">Xóa</button>
		    </div>
		    <div class="mt-5 flex flex-col lg:ml-auto lg:mt-0 lg:flex-row lg:items-center">
			<div>
			    <div class="flex items-center lg:justify-end">
				<div>Tổng thanh toán (0 sản phẩm):</div>
				<div class="text-primary ml-2 text-2xl">₫0</div>
			    </div>
			    <div class="flex items-center text-sm lg:justify-end">
				<div class="text-gray-500">Tiết kiệm</div>
				<div class="text-primary ml-6">₫0</div>
			    </div>
			</div>
			<div>
			    <button type="submit" class="bg-primary mt-5 flex h-10 w-full items-center justify-center bg-blue-500 px-10 py-2 text-center text-sm uppercase text-white hover:bg-blue-600 lg:ml-4 lg:mt-0">Mua hàng</button>
			</div>
		    </div>
		</div>
	    </div>
